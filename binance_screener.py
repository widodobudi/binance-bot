...
─────────────────────────────────────────────────────────
  ...
  FASE 1    Kumpulkan Kandidat Pool (sepanjang candle)
            ...
            8. Harga dalam zona 0% s.d. −5% di bawah EMA50 4H
...
def check_screener(df, chg_24h, vol_usd=0):
    ...
    6. Stoch K > D
    7. Volume buy (tbbav) candle ini > candle sebelumnya
    8. Harga dalam zona 0% s.d. -5% di bawah EMA50 (4H) — tidak boleh di atas maupun lebih dari 5% di bawah EMA50
    """
    ...
    if price_now >= ema50_val:      # di atas atau sama dengan EMA50 → skip
        return False, {}
    if price_now < ema50_lower:     # lebih dari 5% di bawah EMA50 → skip
        return False, {}
...
if __name__ == '__main__':
    ...
    send_telegram(
        ...
        "2️⃣ <b>Fase 1</b> — Pool: 8 syarat (Chg −10%..+3%, Vol, ST, Elapsed, RSI, Stoch, VolBuy, EMA50 zona −5%)\n"
